...
from utils import init_seeds, get_residual_features, get_mc_matched_ref_features, get_mc_reference_features,get_mc_soft_matched_features
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in enumerate(train_loader):
            ...
            mfeatures = get_mc_soft_matched_features(features, class_names, ref_features)
